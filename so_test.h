...
/*   Updated: 2022/02/10 00:53:22 by zwalad           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		x_move_x(int keycode, t_jinx *p, int x, int y, int i);
int		y_move_y(int keycode, t_jinx *p, int x, int y, int i);
int		count_x(char **argv);
int		ez_exit(int i);
char	**mapi(char **argv);
t_jinx	sub_main(t_jinx *p, int argc, char **argv);
int		sub_move(int keycode, int x, int y, t_jinx *p, int i);
